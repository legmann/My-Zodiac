...
const zodiacList = [
...

  {
    ...
    description: `Сильними сторонами представниками цього знаку Зодіаку є розвинена інтуїція й уміння пристосовуватися до будь-якого громадського порядку, бути своїм у будь-якому середовищі, знаходячи найкращі виходи зі скрутного становища.
    ...
    men: `Чоловіки-Риби — мрійники, які ставлять перед собою нереальну мету в повній впевненості, що зможуть її досягти, і часто їм це дійсно вдається. Ухвалюючи важливі життєві рішення, вони до останнього сумніваються в їхній правильності, а у взаєминах демонструють недовірливість і вразливість. Чоловіки-Риби гостро переживають свої невдачі, через що схильні до нудьги і депресії. Водночас вони дуже доброзичливі і товариські, завдяки чому легко знаходять спільну мову з найбільш незговірливими співрозмовниками. Кохану жінку вони, як правило, ідеалізують, вважаючи її не просто дружиною і подругою, а згідно із середньовічнихми традиціями — дамою серця.`,
